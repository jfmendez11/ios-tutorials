...
//  PlayingCard
//
//  Created by Juan Felipe Méndez on 15/06/20.
...
extension PlayingCardView {
    private struct SizeRatio {
        static let cornerFontSizeToBoundsHeigth: CGFloat = 0.085
    ...
    private var cornerFontSize: CGFloat {
        return bounds.size.height * SizeRatio.cornerFontSizeToBoundsHeigth
    }
